/**
 * Encryption support for Document Management Integration Service.
 *
 * Provides XOR-SHA256-derived encryption/decryption for document content
 * stored in internal repositories. Encryption keys are controlled by the
 * service operator, ensuring data is stored in an encrypted format.
 */
module uim.sap.docmgmtintegration.encryption;
...
class EncryptionManager {
    ...
    ubyte[] decrypt(string ciphertextBase64) const {
        ...
        try {
            ...
            throw new DocMgmtIntegrationValidationException("Invalid Base64 ciphertext");
        }
