module uim.sap.docmgmtintegration.exceptions;
...
class DocMgmtIntegrationValidationException : DocMgmtIntegrationException {
    this(string message) {
...
class DocMgmtIntegrationNotFoundException : DocMgmtIntegrationException {
...
class DocMgmtIntegrationAuthorizationException : DocMgmtIntegrationException {
    this(string message) {
...
class DocMgmtIntegrationConfigurationException : DocMgmtIntegrationException {
    this(string message) {
...
class DocMgmtIntegrationConflictException : DocMgmtIntegrationException {
    this(string message) {
...
class DocMgmtIntegrationPayloadTooLargeException : DocMgmtIntegrationException {
    this(string message) {
        super("Payload too large: " ~ message);
    }
}

/// Thrown when a tenant is required but not provided (maps to HTTP 400).
class DocMgmtIntegrationTenantRequiredException : DocMgmtIntegrationException {
    this(string message) {
        super("Tenant required: " ~ message);
    }
}
