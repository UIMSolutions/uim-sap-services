...
class AASServer {
    ...
    private void handleRequest(HTTPServerRequest req, HTTPServerResponse res) {
        ...
        try {
            ...
            if (subPath.startsWith("/apps/") && req.method == HTTPMethod.GET && !subPath.endsWith("/policies")) {
                validateAuth(req);
            ...
            if (subPath.startsWith("/cf/apps/") && subPath.endsWith("/scale") && req.method == HTTPMethod.POST) {
                validateAuth(req);
