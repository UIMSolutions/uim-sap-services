...
class CONService : SAPService {
    ...
    Json health() {
        ...
        payload["connector_location_id"] = _config.connectorLocationId;
        payload["destinations"] = cast(long)_store.countDestinations();
        return payload;
    }
    ...
    Json supportedProtocols() {
        ...
        foreach (protocol; CON_SUPPORTED_PROTOCOLS) {
            protocols ~= protocol;
        }
