...
private OBSProvider parseProvider(string s) {
  switch (s) {
  case "aws_s3":
    return OBSProvider.awsS3;
  case "azure_blob":
    return OBSProvider.azureBlob;
  case "gcp_storage":
    return OBSProvider.gcpStorage;
  default:
    return OBSProvider.awsS3;
  }
}
...
private OBSAccessLevel parseAccessLevel(string s) {
  switch (s) {
  case "private":
    return OBSAccessLevel.private_;
  case "public_read":
    return OBSAccessLevel.publicRead;
  case "public_read_write":
    return OBSAccessLevel.publicReadWrite;
  default:
    return OBSAccessLevel.private_;
  }
}
...
private OBSStorageClass parseStorageClass(string s) {
  switch (s) {
  case "standard":
    return OBSStorageClass.standard;
  case "nearline":
    return OBSStorageClass.nearline;
  case "coldline":
    return OBSStorageClass.coldline;
  case "archive":
    return OBSStorageClass.archive;
  default:
    return OBSStorageClass.standard;
  }
}
