...
private PDMDataCategory parseDataCategory(string s) {
  ...
  case "biometric":
    return PDMDataCategory.biometric;
  case "genetic":
    return PDMDataCategory.genetic;
  default:
    return PDMDataCategory.identification;
  }
}
...
private PDMProcessingPurpose parseProcessingPurpose(string s) {
  ...
  case "vital_interest":
    return PDMProcessingPurpose.vitalInterest;
  case "public_interest":
    return PDMProcessingPurpose.publicInterest;
  default:
    return PDMProcessingPurpose.contractual;
  }
}
...
private PDMLegalBasis parseLegalBasis(string s) {
  ...
  case "PDPA":
    return PDMLegalBasis.pdpa;
  case "PIPA":
    return PDMLegalBasis.pipa;
  case "custom":
    return PDMLegalBasis.custom;
  default:
    return PDMLegalBasis.gdpr;
  }
}
