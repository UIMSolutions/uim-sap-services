...
class ISServer {
    ...
    private void routeTenant(
        ...
        switch (resource) {
            // Cloud Integration
            case "iflows":          routeIFlows(req, res, tenantId, rest); return;
            case "message-logs":    routeMessageLogs(req, res, tenantId, rest); return;

            // API Management
            case "api-proxies":     routeApiProxies(req, res, tenantId, rest); return;
            case "api-products":    routeApiProducts(req, res, tenantId, rest); return;
            case "api-policies":    routeApiPolicies(req, res, tenantId, rest); return;

            // Event Management
            case "event-topics":    routeEventTopics(req, res, tenantId, rest); return;
            case "event-subscriptions": routeEventSubscriptions(req, res, tenantId, rest); return;

            // Open Connectors
            case "connectors":      routeConnectors(req, res, tenantId, rest); return;

            // Integration Advisor
            case "mappings":        routeMappings(req, res, tenantId, rest); return;

            // Trading Partner Management
            case "trading-partners": routeTradingPartners(req, res, tenantId, rest); return;
            case "agreements":      routeAgreements(req, res, tenantId, rest); return;

            // OData Provisioning
            case "odata-services":  routeODataServices(req, res, tenantId, rest); return;

            // Integration Assessment
            case "assessments":     routeAssessments(req, res, tenantId, rest); return;

            // Migration Assessment
            case "migrations":      routeMigrations(req, res, tenantId, rest); return;

            // Hybrid Integration
            case "hybrid-runtimes": routeHybridRuntimes(req, res, tenantId, rest); return;

            // Data Space Integration
            case "data-assets":     routeDataAssets(req, res, tenantId, rest); return;

            // Content Packs
            case "content-packs":   routeContentPacks(req, res, tenantId, rest); return;
