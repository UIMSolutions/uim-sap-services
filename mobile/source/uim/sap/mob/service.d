...
class MOBService : SAPService {
    ...
    Json deleteApp(string appId) {
        ...
        Json payload = Json.emptyObject;
        payload["success"] = true;
        payload["message"] = "Application and all related resources deleted";
    ...
    Json listVersions(string appId) {
        ...
        Json payload = Json.emptyObject;
        payload["resources"] = resources;
        payload["total_results"] = cast(long) vers.length;
        return payload;
    }
    ...
    Json deleteVersion(string appId, string versionId) {
        ...
        Json payload = Json.emptyObject;
        payload["success"] = true;
        payload["message"] = "Version deleted";
        payload["app_id"] = appId;
    ...
    Json activateVersion(string appId, string versionId) {
        ...
        Json payload = Json.emptyObject;
        payload["success"] = true;
        payload["message"] = "Version activated";
        payload["version"] = ver.toJson();
        return payload;
    }
    ...
    Json getPushConfig(string appId) {
        ...
        Json payload = Json.emptyObject;
        payload["push_config"] = _store.getPushConfig(appId).toJson();
        return payload;
    }
    ...
    Json listNotifications(string appId) {
        ...
        Json payload = Json.emptyObject;
        payload["resources"] = resources;
        payload["total_results"] = cast(long) notifs.length;
        return payload;
    }
    ...
    Json setOfflineConfig(string appId, Json request) {
        ...
        Json payload = Json.emptyObject;
        payload["success"] = true;
        payload["offline_config"] = oc.toJson();
        return payload;
    }
    ...
    Json getOfflineConfig(string appId) {
        ...
        Json payload = Json.emptyObject;
        payload["offline_config"] = _store.getOfflineConfig(appId).toJson();
        return payload;
    }
    ...
    Json setSecurityPolicy(string appId, Json request) {
        ...
        Json payload = Json.emptyObject;
        payload["success"] = true;
        payload["security_policy"] = sp.toJson();
        return payload;
    }
    ...
    Json getSecurityPolicy(string appId) {
        ...
        Json payload = Json.emptyObject;
        payload["security_policy"] = _store.getSecurityPolicy(appId).toJson();
        return payload;
    }
    ...
    Json listUsers(string appId) {
        ...
        Json payload = Json.emptyObject;
        payload["resources"] = resources;
        payload["total_results"] = cast(long) users.length;
        return payload;
    }
    ...
    Json wipeUser(string appId, string userId) {
        ...
        Json payload = Json.emptyObject;
        payload["success"] = true;
        payload["message"] = "User data wiped";
        payload["user"] = uc.toJson();
        return payload;
    }
    ...
    Json deleteUser(string appId, string userId) {
        ...
        Json payload = Json.emptyObject;
        payload["success"] = true;
        payload["message"] = "User connection deleted";
        payload["app_id"] = appId;
    ...
    private static Json jsonArray(string[] items) {
        ...
        foreach (s; items) arr.appendArrayElement(Json(s));
        return arr;
    }
}
